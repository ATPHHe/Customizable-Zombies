...
--**    Modified by:        ATPHHe                          **
--**                                                        **
--**    Description: UI display with a question or text     **
--**        can display a yes/no button or ok btn           **
--************************************************************

ISScrolledModalRichTextCZ = ISPanelJoypad:derive("ISScrolledModalRichTextCZ");

local FONT_HGT_SMALL = getTextManager():getFontHeight(UIFont.Small)

--************************************************************************--
--** ISScrolledModalRichTextCZ:initialise
--**
--************************************************************************--

function ISScrolledModalRichTextCZ:initialise()
	ISPanelJoypad.initialise(self);
	local btnWid = 100
	local btnHgt = math.max(25, FONT_HGT_SMALL + 3 * 2)
	local padBottom = 10
	if self.yesno then
		self.yes = ISButton:new((self:getWidth() / 2) - btnWid - 5, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_Yes"), self, ISScrolledModalRichTextCZ.onClick);
		...
		self.no = ISButton:new((self:getWidth() / 2) + 5, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_No"), self, ISScrolledModalRichTextCZ.onClick);
		self.no.internal = "NO";
		...
		self.ok = ISButton:new((self:getWidth() / 2) - btnWid / 2, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_Ok"), self, ISScrolledModalRichTextCZ.onClick);
		self.ok.internal = "OK";
...
function ISScrolledModalRichTextCZ:updateButtons()
	local btnHgt = math.max(25, FONT_HGT_SMALL + 3 * 2)
    local padBottom = 10
    if self.yesno then
...
function ISScrolledModalRichTextCZ:destroy()
...
function ISScrolledModalRichTextCZ:onClick(button)
	self:destroy();
...
function ISScrolledModalRichTextCZ:prerender()
...
function ISScrolledModalRichTextCZ:onMouseDown(x, y)
...
function ISScrolledModalRichTextCZ:onGainJoypadFocus(joypadData)
...
function ISScrolledModalRichTextCZ:onJoypadDown(button)
...
function ISScrolledModalRichTextCZ:onJoypadDirRight()
	if self.yesno then
...
function ISScrolledModalRichTextCZ:onJoypadDirLeft()
	if self.yesno then
...
function ISScrolledModalRichTextCZ:update()
...
function ISScrolledModalRichTextCZ:setHeightToContents()
	local btnHgt = math.max(25, FONT_HGT_SMALL + 3 * 2)
	local minHeight = self.height
	self:setHeight(minHeight)
	--self:ignoreHeightChange()
...
--************************************************************************--
--** ISScrolledModalRichTextCZ:new
--**
--************************************************************************--
function ISScrolledModalRichTextCZ:new(x, y, width, height, text, yesno, target, onclick, player, param1, param2)
	local o = {}
